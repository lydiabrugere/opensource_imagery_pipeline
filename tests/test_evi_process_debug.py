...
class TestL7EVIProcess(unittest.TestCase):
    ...
    def test5_img_to_gs_pub(self):
        ...
        print "expected_additions: ", expected_additions
        print "\n"
        print "observed_additions: ", observed_additions
        print "\n"
        print "files_before_gs_pub: ", files_before_gs_pub
        print "\n"
        print "files_after_gs_pub: ", files_after_gs_pub
